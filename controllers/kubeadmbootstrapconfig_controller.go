...
// +kubebuilder:rbac:groups=kubeadm.bootstrap.k8s.io,resources=kubeadmbootstrapconfigs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kubeadm.bootstrap.k8s.io,resources=kubeadmbootstrapconfigs/status,verbs=get;update;patch
